...
public class ApiHttpClient
{
    ...
    /// <summary>
    /// Inicializa uma nova instância da classe <see cref="ApiHttpClient"/>.
    /// </summary>
    /// <param name="urlBase">Url base da comunicação</param>
    public ApiHttpClient(string urlBase)
    {
    ...
    {
        T result = await SendAsync<T>(null, HttpMethod.Get, mimeType, cancellationToken);
        return result;
    }
...
/// <summary>
/// Contem metodos para utilizar a classe <see cref="ApiHttpClient"/>.
/// </summary>
internal static class PixHttpClientHelper
{
    ...
    internal static ApiHttpClient PrepareClient(this ApiHttpClient client, string endPoint, params string[] query)
    {
